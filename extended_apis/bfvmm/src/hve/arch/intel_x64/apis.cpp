...
apis::apis(
    ...
    m_encls_handler{this, eapis_vcpu_state->eapis_vcpu_global_state()},
...
gsl::not_null<encls_handler *>
apis::encls()
{ return &m_encls_handler; }


void
apis::enable_encls()
{ m_encls_handler.enable(); }

void
apis::disable_encls()
{ m_encls_handler.disable(); }
